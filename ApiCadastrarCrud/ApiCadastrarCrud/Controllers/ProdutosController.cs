...
using ApiCadastrarCrud.Data;
using ApiCadastrarCrud.Entidades;

namespace ApiCadastrarCrud.Controllers
{
    ...
    public class ProdutosController : ControllerBase
    {
        ...
        {
            List<Produto> produtos = await _context.Produtos.AsNoTracking().Skip(pageNumber * pageSize).Take(pageSize).ToListAsync();
